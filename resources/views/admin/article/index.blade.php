    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            jQuery(grid_selector).jqGrid({
                ...
                datatype: "json",
                height: 250,
                colNames:[' ', 'ID','Title','User Id', 'Created At', 'Updated At'],
                colModel:[
...
*/
                    ...
                    { name: 'user_id', index: 'user_id', width: 180,editable: true },
                    { name: 'created_at', index: 'create_at', width: 180 ,editable: true},
                    { name: 'updated_at', index: 'update_at', width: 180,editable: true }
                ],
